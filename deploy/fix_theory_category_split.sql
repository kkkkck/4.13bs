...
INSERT INTO `category` (`id`, `name`, `description`, `sort`, `parent_id`, `practice_mode`, `status`) VALUES
  ...
  (2101, '导论', '新思想章节', 1, 6, 2, 1),
  (2102, '第一章 新时代坚持和发展中国特色社会主义', '新思想章节', 2, 6, 2, 1),
  (2103, '第二章 以中国式现代化全面推进中华民族伟大复兴', '新思想章节', 3, 6, 2, 1),
  (2104, '第三章 坚持党的全面领导', '新思想章节', 4, 6, 2, 1),
  (2105, '第四章 坚持以人民为中心', '新思想章节', 5, 6, 2, 1),
  (2106, '第五章 全面深化改革开放', '新思想章节', 6, 6, 2, 1),
  (2107, '第六章 推动高质量发展', '新思想章节', 7, 6, 2, 1),
  (2108, '第七章 社会主义现代化建设的教育、科技、人才战略', '新思想章节', 8, 6, 2, 1),
  (2109, '第八章 发展全过程人民民主', '新思想章节', 9, 6, 2, 1),
  (2110, '第九章 全面依法治国', '新思想章节', 10, 6, 2, 1),
  (2111, '第十章 建设社会主义文化强国', '新思想章节', 11, 6, 2, 1),
  (2112, '第十一章 以保障和改善民生为重点加强社会建设', '新思想章节', 12, 6, 2, 1),
  (2113, '第十二章 建设社会主义生态文明', '新思想章节', 13, 6, 2, 1),
  (2114, '第十三章 维护和塑造国家安全', '新思想章节', 14, 6, 2, 1),
  (2115, '第十四章 建设巩固国防和强大人民军队', '新思想章节', 15, 6, 2, 1),
  (2116, '第十五章 坚持“一国两制”和推进祖国完全统一', '新思想章节', 16, 6, 2, 1),
  (2117, '第十六章 中国特色大国外交和推动构建人类命运共同体', '新思想章节', 17, 6, 2, 1),
  (2118, '第十七章 全面从严治党', '新思想章节', 18, 6, 2, 1)
...
UPDATE `category`
SET `parent_id` = 6, `practice_mode` = 2, `status` = 1, `sort` = 100 + (`id` - 2133000)
